 ...
 * Icon Library
 * 
 * Collection of essential SVG icons for the Zynk website.
 * All icons are 24x24 viewBox with customizable size.
 * Use aria-label for standalone icons, aria-hidden for decorative icons.
 */
